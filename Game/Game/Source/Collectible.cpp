...
void CollectibleSystem::Initialize(s8 font) {
    font_ = font;
    collectionText_ = Text(-0.6f, 0.92f, "Items: 0/3");
    CreateMeshes();
    collectedCount_ = 0;
...
void CollectibleSystem::Draw() {
    ...
    const char* textStr = collectionText_.text_.c_str();
    AEGfxSetRenderMode(AE_GFX_RM_TEXTURE);
    AEGfxPrint(font_, textStr, collectionText_.pos_x_, collectionText_.pos_y_, 1.0f, 1.0f, 1.0f,
               1.0f, 1.0f);
}
