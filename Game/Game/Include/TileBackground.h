...
@brief      This header file contains the declarations of the TiledBackground class,
            which loads and renders a screen-filling tiled texture background from JSON.
